...
"""Launch realsense2_camera_t265 node without rviz2."""
...
local_parameters = [{'name': 'camera_name1', 'default': 'D455', 'description': 'camera unique name'},
                    {'name': 'device_type1', 'default': 'd455', 'description': 'choose device by type'},
