...
'''
Launch realsense2_camera_t265 node & a frame latency printer node, 
This tool allow the user the evaluate the reduction of the frame latency when intra-process communication is used.
Run syntax: ros2 launch realsense2_camera_t265 rs_intra_process_demo_launch.py intra_process_comms:=true
Note: 
